...
template<class State, class Trajectory, class System>
RRTstar::Vertex<State, Trajectory, System>::Vertex(const Vertex<State, Trajectory, System> &vertexIn) {
	...
	for (typename std::set<Vertex<State, Trajectory, System> *>::const_iterator iter = vertexIn.children.begin();
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::insertIntoKdtree(Vertex<State, Trajectory, System> &vertexIn) {
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::getNearestVertex(State &stateIn,
                                                                  Vertex<State, Trajectory,
                                                                         System> *&vertexPointerOut) {
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::getNearVertices(State &stateIn,
                                                                 std::vector<Vertex<State, Trajectory,
                                                                                    System> *> &vectorNearVerticesOut) {
	...
	double ballRadius = gamma * pow(log((double) (numVertices + 1.0)) / ((double) (numVertices + 1.0)),
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::checkUpdateBestVertex(Vertex<State, Trajectory, System> &vertexIn) {
...
RRTstar::Planner<State, Trajectory, System>::insertTrajectory(Vertex<State, Trajectory, System> &vertexStartIn,
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::insertTrajectory(Vertex<State, Trajectory, System> &vertexStartIn,
                                                                  Trajectory &trajectoryIn,
...
template<class State, class Trajectory, class System>
RRTstar::Vertex<State, Trajectory, System> &RRTstar::Planner<State, Trajectory, System>::getRootVertex() {
...
template<class State, class Trajectory, class System>
int compareVertexCostPairs(std::pair<RRTstar::Vertex<State, Trajectory, System> *, double> i,
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::findBestParent(State &stateIn,
                                                                std::vector<Vertex<State, Trajectory,
                                                                                   System> *> &vectorNearVerticesIn,
                                                                Vertex<State, Trajectory, System> *&vertexBest,
                                                                Trajectory &trajectoryOut, bool &exactConnection) {
	...
	int i = 0;
	for (typename std::vector<Vertex<State, Trajectory, System> *>::iterator iter = vectorNearVerticesIn.begin();
	...
	for (typename std::vector<std::pair < Vertex<State, Trajectory, System> * , double> >
		::iterator iter = vectorVertexCostPairs.begin(); iter != vectorVertexCostPairs.end();
	iter++) {
...
template<class State, class Trajectory, class System>
int
RRTstar::Planner<State, Trajectory, System>::updateBranchCost(Vertex<State, Trajectory, System> &vertexIn, int depth) {


	// Update the cost for each children
	for (typename std::set<Vertex<State, Trajectory, System> *>::iterator iter = vertexIn.children.begin();
	     iter != vertexIn.children.end(); iter++)
	{
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::rewireVertices(Vertex<State, Trajectory, System> &vertexNew,
                                                                std::vector<Vertex<State, Trajectory,
                                                                                   System> *> &vectorNearVertices) {

	bool exactConnection = false;
	// Repeat for all vertices in the set of near vertices
	for (typename std::vector<Vertex<State, Trajectory, System> *>::iterator iter = vectorNearVertices.begin();
	     iter != vectorNearVertices.end(); iter++)
	{
		...
		double costCurr = system->evaluateExtensionCost(*(vertexNew.state), *(vertexCurr.state),
		                                                exactConnection);
		if (not exactConnection || costCurr < 0)
		{
			continue;
		}
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::iteration(double (&node)[2], double px, double py) {
...
template<class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::getBestTrajectory(std::list<double *> &trajectoryOut) {
