 ...
 */
typedef void(*lcmtypes_vertex_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const lcmtypes_vertex_t *msg, void *userdata);
 ...
 */
lcmtypes_vertex_t_subscription_t* lcmtypes_vertex_t_subscribe(
    lcm_t *lcm, const char *channel, lcmtypes_vertex_t_handler_t handler, void *userdata);
 ...
 * @return 0 on success, <0 if an error occured
 */
int lcmtypes_vertex_t_subscription_set_queue_capacity(
    lcmtypes_vertex_t_subscription_t* subs, int num_messages);
...
int __lcmtypes_vertex_t_encode_array(
    void *buf, int offset, int maxlen, const lcmtypes_vertex_t *p, int elements);
int __lcmtypes_vertex_t_decode_array(
    const void *buf, int offset, int maxlen, lcmtypes_vertex_t *p, int elements);
